...
## 如果你不想手机端被挤下线的话，建议测试一下云端系统是否可使用

> 第一种情况，云端系统可用，那么你可以直接看下面的配合腾讯云函数使用，或者如果你自己有服务器，也完全可以使用定时任务挂在你自己的服务器上
...
## 如果很不幸，你们学校学生账号的云端系统被禁用，那么你需要使用通用脚本，参考步骤如下
...
> 如果大家一直支持我，捐赠我的话，会继续维护

## 7. 邮件接口已到达上限？能使用自己的邮箱发送邮件吗？

> 由于使用人数过多，邮件确实已经到达上限了（我还是vip账户，都扛不住），所以应该时不时的会有发送邮件不成功的日志，正在考虑使用负载均衡，使用多个邮箱账户来发送邮件，如果你对此感兴趣，欢迎来群里交流
